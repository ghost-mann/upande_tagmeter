...
GROUPS = [
	...
	("Configuration", [
		("TagMeter Settings", "/app/tagmeter-settings", "TagMeter Settings",
		 "Credentials, pacing and every threshold", "#475569",
		...
		("Scheduled Job Type", "/app/scheduled-job-type?method=%5B%22like%22%2C%22%25upande_tagmeter%25%22%5D",
		 "Scheduled Jobs",
		 "What runs on its own, and when it last did", "#64748b",
		 '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>'),
		("Error Log", "/app/error-log?error=%5B%22like%22%2C%22%25TagMeter%25%22%5D", "Integration Errors",
		 "What the SMP refused, and why", "#9f1239",
		 '<path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/>'
		 '<line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>'),
	]),
]
...
SIDEBAR_ITEMS = [
	...
	{"label": "Meter Command", "type": "Link", "link_type": "DocType", "link_to": "Meter Command",
	 "icon": "sliders"},
	{"label": "Settings", "type": "Link", "link_type": "DocType", "link_to": "TagMeter Settings",
	 "icon": "setting"},
]
